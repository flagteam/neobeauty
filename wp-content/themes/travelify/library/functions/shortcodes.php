...
function travelify_colorawesome_link() {
   return '<a href="'.esc_url( 'https://www.facebook.com/pages/Flag-Team/483376315098901' ).'" target="_blank" title="'.esc_attr__( 'Flag Team', 'travelify' ).'" ><span>'.__( 'Flag Team', 'travelify') .'</span></a>';
}
